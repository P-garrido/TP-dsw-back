...
export class UserModel {
  ...
  static async createUser({ input }) {
    ...
    await connection.query('insert into usuarios(nombre_usuario, clave, email, telefono, nombre, apellido, direccion, tipo_usuario) values (?,?,?,?,?,?,?,?)', [nombre_usuario, clave, email, telefono, nombre, apellido, direccion, tipo_usuario])
    ...
    const {
     ...
     try {
      await connection.query(
        ...
        WHERE id_usuario=?;`, [clave, email, telefono, nombre, apellido, direccion, tipo_usuario, id]
      );
